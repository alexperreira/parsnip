...
- After any commit-worthy task, draft a commit message and ask for approval before committing.
...
- Only add files you edited in this session to commits; ignore others unless instructed.
